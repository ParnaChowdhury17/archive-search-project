...
export function SearchBar({
  ...
  return (
    <div className="glass-card p-4 md:p-6 flex flex-col gap-4">
      ...
      {/* Date Range Filter (UI Placeholder to keep future-ready without breaking API) */}
      <div className="pt-3 border-t border-white/5 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-400">
        <div className="flex items-center gap-2">
          ...
          <span>Optional filters (UI-only placeholder)</span>
        </div>
        <div className="flex items-center gap-4">
          <label className="flex items-center gap-1.5 opacity-60 cursor-not-allowed select-none">
            <input
              type="checkbox"
              disabled
